...
const navItems = [
  ...
  { href: '/review', label: 'Review', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-slate-900 text-white flex flex-col flex-shrink-0 h-screen">
      <div className="px-6 py-5 border-b border-slate-700">
        <h1 className="text-lg font-bold tracking-tight">Airbnb Link Finder</h1>
        <p className="text-xs text-slate-400 mt-1">Lead Research Tool</p>
      </div>
